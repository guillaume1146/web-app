...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://api.dicebear.com https://mcb.mu https://via.placeholder.com https://storage.googleapis.com",
      "connect-src 'self' https://api.groq.com wss: ws:",
      "media-src 'self' blob:",
      "frame-src 'self'",
      "object-src 'none'",
      "base-uri 'self'",
