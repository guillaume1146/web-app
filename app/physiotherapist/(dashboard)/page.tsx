...
export default function PhysioDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Physiotherapist Dashboard</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <p className="text-gray-600">Your physiotherapist dashboard is ready. Use the sidebar to navigate.</p>
      </div>
    </div>
  )
}
