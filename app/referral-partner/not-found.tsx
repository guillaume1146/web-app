...
export default function ReferralPartnerNotFound() {
 return (
 ...
 <h1 className="text-3xl font-bold text-gray-900 mb-3">Referral Partner Page Not Found</h1>
 <p className="text-gray-600 mb-8 leading-relaxed">
 The referral partner page you are looking for does not exist or has been moved.
 </p>
