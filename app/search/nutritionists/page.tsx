...
export default function SearchNutritionistsPage() {
  ...
  useEffect(() => {
    fetch('/api/search/providers?type=NUTRITIONIST')
      .then(r => r.json())
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Find Nutritionists</h1>
      {providers.length === 0 ? (
        <p className="text-gray-500 text-center py-12">No nutritionists available yet. Check back soon!</p>
      ) : (
