...
export default function SearchCaregiversPage() {
  ...
  useEffect(() => {
    fetch('/api/search/providers?type=CAREGIVER')
      .then(r => r.json())
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Find Caregivers</h1>
      {providers.length === 0 ? (
        <p className="text-gray-500 text-center py-12">No caregivers available yet. Check back soon!</p>
      ) : (
