...
import { FaClipboardList, FaPills } from 'react-icons/fa'

const OrdersContent = dynamic(() => import('../orders/page'), { ssr: false, loading: () => <TabLoading /> })
const InventoryContent = dynamic(() => import('../inventory/page'), { ssr: false, loading: () => <TabLoading /> })
