...
export default function BloodPressureScanner() {
  ...
  if (phase === 'idle') {
    return (
      <button
        onClick={startScan}
        className="w-full flex items-center gap-3 p-4 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-xl hover:shadow-md transition group"
      >
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500 to-pink-500 flex items-center justify-center flex-shrink-0 group-hover:shadow-lg transition">
