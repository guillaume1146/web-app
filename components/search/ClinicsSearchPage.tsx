...
function EntityCard({ entity }: { entity: ClinicEntity }) {
...
export default function ClinicsSearchPage() {
  ...
  const fetchClinics = useCallback(async (q: string, type: string) => {
    setLoading(true)
    try {
      ...
      params.set('limit', '24')
      const res = await fetch(`/api/search/clinics?${params}`)
  ...
  useEffect(() => {
    fetchClinics(query, selectedType)
  }, [fetchClinics, query, selectedType])
      ...
      <div className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-8">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-[#001E40]">Find a Clinic</h1>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="font-bold text-[#001E40] text-lg mb-1">No clinics found</h3>
